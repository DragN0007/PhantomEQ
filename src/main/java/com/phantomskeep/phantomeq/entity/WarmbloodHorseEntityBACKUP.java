...
public class WarmbloodHorseEntityBACKUP extends AbstractHorse implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    private int animTimer = 0;
    private int idleAnimCooldown = 0;
    public WarmbloodHorseEntityBACKUP(EntityType<? extends AbstractHorse> entityType, Level level) {
    ...
    public void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new BreedGoal(this, 1.0D, WarmbloodHorseEntityBACKUP.class));
...
//        }
    ...
    private static final EntityDataAccessor<Integer> VARIANT = SynchedEntityData.defineId(WarmbloodHorseEntityBACKUP.class, EntityDataSerializers.INT);
    ...
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE_GENDER =
            SynchedEntityData.defineId(WarmbloodHorseEntityBACKUP.class, EntityDataSerializers.INT);
    @Override
    ...
    public boolean canMate(Animal animal) {
        if (animal == this) {
            return false;
        } else if (!(animal instanceof Donkey) && !(animal instanceof WarmbloodHorseEntityBACKUP)) {
            return false;
        } else {
            return this.canBeParent() && ((WarmbloodHorseEntityBACKUP)animal).canBeParent();
        }
    }
   /* @Nullable
    ...
    public SlotAccess createEquipmentSlotAccess(final int p_149503_, final Predicate<ItemStack> p_149504_) {
        return new SlotAccess() {
            public ItemStack get() {
                return WarmbloodHorseEntityBACKUP.this.inventory.getItem(p_149503_);
            }
            ...
            public boolean set(ItemStack p_149528_) {
                if (!p_149504_.test(p_149528_)) {
                    ...
                    WarmbloodHorseEntityBACKUP.this.inventory.setItem(p_149503_, p_149528_);
                    WarmbloodHorseEntityBACKUP.this.updateContainerEquipment();
                    return true;
                }
            }
        };
