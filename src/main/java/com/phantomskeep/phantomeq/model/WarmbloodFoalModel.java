...
public class WarmbloodFoalModel extends AnimatedGeoModel<WarmBloodFoalEntity> {
    ...
    @Override
    public ResourceLocation getModelLocation(WarmBloodFoalEntity object) {
        return model;
    }

    @Override
    public ResourceLocation getTextureLocation(WarmBloodFoalEntity object) {
        return object.getTextureLocation();
    }

    @Override
    public ResourceLocation getAnimationFileLocation(WarmBloodFoalEntity animatable) {
        return animation;
    }
}
